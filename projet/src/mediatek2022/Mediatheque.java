...
// ********** action sur le document ***********************
	...
	//enregistre le retour du document d)
		...
		//
		// ====>J'ai supprimé le parametre "Utilisateur a" car il est inutile 
		//
		
		/*public void retour (Document d,Utilisateur u) throws Exception {
			d.retour();
		}*/
		public void retour (Document d) throws Exception {
			d.retour();
		}
